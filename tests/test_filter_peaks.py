...
manager.connect(filter_1.output, [mad_estimator.input, writer_1.input, peak_detector.get_input('data')])
...
for count, i in enumerate(range(start_mad-1, start_mad+10)):
