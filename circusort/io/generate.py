...
def default(path, visualization=False):
    ...
    synthetic_grid(path, visualization=visualization)
...
class Channel(object):
    ...
    def __repr__(self):
        ...
        repr_ = "Channel {} (".format(self.id)
        repr_ += " x: {}".format(self.x)
        repr_ += " y: {}".format(self.y)
        repr_ += ")"
...
class Cell(object):
    ...
    def __init__(self, id_, c, x, y, t, scale=0.5, refactory_period=20.0e-3):
